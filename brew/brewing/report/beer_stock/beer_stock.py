# Copyright (c) 2013, Metalman Brewing and contributors
...
def get_columns():
	return [_("Item Code") + ":Link/Item:200", 
		#_("Item Name") + "::100", 
		#_("Description") + "::200",
		...
		#_("UOM") + ":Link/UOM:100", 
		_("Qty In Stock") + ":Int:100", 
		#_("Planned Qty") + ":Float:100",   hiding this one for now but want to integrate this back in when feeding in from production
		#_("Requested Qty") + ":Float:110", 
		#_("Ordered Qty") + ":Float:100",
		_("Advance Orders") + ":Int:100", 
		#_("Reserved Qty for Production") + ":Float:100",
		_("Projected Qty") + ":Int:100", 
		#_("Reorder Level") + ":Float:100", 
		#_("Reorder Qty") + ":Float:100",
		_("Shortage Qty") + ":Int:100"]
...
def get_data(filters):
	...
	for bin in bin_list:
		...
		#	item.stock_uom, 
			bin.actual_qty, 
		#	bin.planned_qty,    reintroduce this when it makes sense
		#	bin.indented_qty, 
		#	bin.ordered_qty,
			bin.reserved_qty, 
...
#               conditions.append("item_group = '%s' "%filters.item_group)
